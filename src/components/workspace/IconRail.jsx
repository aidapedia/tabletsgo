import { CodeIcon, GridIcon, HomeIcon, SettingsIcon } from '../icons.jsx'
    ...
    <div className="flex w-[56px] shrink-0 flex-col items-center border-r border-edge bg-bg py-3">
      ...
      <Popover
        ...
        trigger={({ toggle }) => (
          <button
            onClick={toggle}
            title={current?.name || 'Connections'}
      ...
      <div className="flex flex-col items-center gap-1.5">
        <RailButton icon={GridIcon} label="Data Browser" active={active === 'browser'} onClick={onBrowser} />
      ...
      <div className="mt-auto flex flex-col items-center gap-1.5">
        ...
        <button
          title={user?.name ? `${user.name} — sign out` : 'Profile'}
