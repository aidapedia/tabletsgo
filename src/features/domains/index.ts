...
// connection's tables (one domain per table), with a picker modal and a colored
// dot. Drives the sidebar's group-by-domain view and the schema-diagram regions.
export { default as DomainPickerModal } from './components/DomainPickerModal'
