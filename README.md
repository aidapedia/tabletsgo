...
- 🎨 **Visual schema designer** — model tables and relationships on a React Flow canvas, annotate it with notes, and stage the DDL as reviewable changes; the layout you arrange is saved with the draft and travels in the design export.
